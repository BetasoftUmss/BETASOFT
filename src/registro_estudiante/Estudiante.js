...
const baseUrl = "https://app-betaweb.herokuapp.com/api/NewEstudiante";
const baseUrl2 = "https://app-betaweb.herokuapp.com/api/NewUser";
const estudiante = {};
var datapost = {};
var respuesta = null;
const baseUrl3 = "https://app-betaweb.herokuapp.com/api/estudiantesList";
...
estudiante.create = async (state) => {
  ...
  await axios
    ...
    .then(async (response) => {
      ...
      await axios.get(baseUrl3).then(async (responses) => {
        var idestudiante;
